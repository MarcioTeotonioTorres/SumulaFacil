...
public class SumulaFacil extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SumulaFacil frame = new SumulaFacil();
	...
	public SumulaFacil() {
		setTitle("Login");
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(SumulaFacil.class.getResource("/imagens/Login_37128.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(SumulaFacil.class.getResource("/imagens/Lock-Lock-icon.png")));
